...
const helpContent = {
	shellType: {
		header: 'Kiểu pháo',
		body: 'Loại pháo hoa sẽ được tung ra. Chọn "Ngẫu nhiên" để có một loại tốt đẹp!'
	},
	shellSize: {
		header: 'Kích cỡ',
		body: 'Kích thước của pháo hoa. Được mô phỏng theo kích thước vỏ pháo hoa thật, vỏ lớn hơn có vụ nổ lớn hơn với nhiều ngôi sao hơn và đôi khi có nhiều hiệu ứng phức tạp hơn. Tuy nhiên, vỏ lớn hơn cũng đòi hỏi sức mạnh xử lý nhiều hơn và có thể gây ra độ trễ.'
	},
	quality: {
		header: 'Chất lượng',
		body: 'Chất lượng đồ họa tổng thể. Nếu hoạt ảnh không chạy trơn tru, hãy thử giảm chất lượng. Chất lượng cao làm tăng đáng kể số lượng tia lửa được hiển thị và có thể gây ra độ trễ.'
	},
	skyLighting: {
		header: 'Bầu trờitrời',
		body: 'Chiếu sáng nền khi pháo hoa nổ. Nếu nền trông quá sáng trên màn hình của bạn, hãy thử đặt nền thành "Mờ" hoặc "Không".'
	},
	scaleFactor: {
		header: 'Tỷ lệ',
		body: 'Cho phép thu nhỏ kích thước của tất cả pháo hoa, về cơ bản là di chuyển bạn đến gần hơn hoặc xa hơn. Đối với kích thước vỏ lớn hơn, có thể thuận tiện để giảm tỷ lệ một chút, đặc biệt là trên điện thoại hoặc máy tính bảng.'
	},
	autoLaunch: {
		header: 'Tự khởi động',
		body: 'Tự động bắn các chuỗi pháo hoa. Ngồi lại và thưởng thức chương trình hoặc tắt để có toàn quyền kiểm soát.'
	},
	finaleMode: {
		header: 'Đồng loạt',
		body: 'Tung ra những đợt pháo hoa dữ dội. Có thể gây lag. Yêu cầu bật "Tự động kích hoạt".'
	},
	hideControls: {
		header: 'Ẩn tương tác',
		body: 'Ẩn các điều khiển mờ dọc theo đầu màn hình. Hữu ích cho ảnh chụp màn hình hoặc chỉ là trải nghiệm liền mạch hơn. Khi bị ẩn, bạn vẫn có thể nhấn vào góc trên cùng bên phải để mở lại menu này.'
	},
	fullscreen: {
	...
	longExposure: {
		header: 'Chế độ lưu ảnh',
		body: 'Hiệu ứng thử nghiệm giúp duy trì các vệt sáng dài, tương tự như để màn trập máy ảnh mở.'
	}
};
...
function init() {
	...
	setOptionsForSelect(appNodes.skyLighting, [
		...
		{ label: 'Lờ mờ', value: SKY_LIGHT_DIM },
		{ label: 'Bình thưởng', value: SKY_LIGHT_NORMAL }
	]);
